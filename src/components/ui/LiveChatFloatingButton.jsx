  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-gold-500/15 text-gold-400 border border-gold-500/30 group-hover:bg-gold-500 group-hover:text-ink-950 transition-colors duration-200 pointer-events-none">
